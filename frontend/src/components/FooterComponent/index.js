    ...
    return (
        <div className="Footer">
            ...
            Sam:
                ...
                <div ><a className='g-point' href='https://github.com/Alsm867'><img className='g-hub' src='https://res.cloudinary.com/dzjkwepju/image/upload/v1637101398/Styckr/Untitled_design_o5b62v.png' alt='ghub' width='30px' height='30px'></img></a></div>
